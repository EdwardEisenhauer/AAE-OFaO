...
\begin{enumerate}
    \item Draw the plot showing dependence of $r_H$ and $\Phi_H$ upon incidence angle for TM wave.
    Explain the origin and the  meaning of characteristic points on this plot . Indicate orientation of the E i H vectors with respect to incidence plane. 
\end{enumerate}

\include{sources/02_TE_wave}

\begin{enumerate}
    \item Define the loss coefficient for optical waveguides. In what units we measured losses in optical fibers.  
\end{enumerate}

\include{sources/04_Numerical_Aperture}
...
\include{sources/11_Some_task}

\include{sources/12_Loses}
